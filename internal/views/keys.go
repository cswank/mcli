...
func (s *screen) getKeys() []key {
	return []key{
		...
		{views: []string{"body"}, keys: []interface{}{'e'}, keybinding: s.showEqualizer, help: keyHelp{key: "e", body: "show the equalizer"}},
		...
		{views: []string{"equalizer"}, keys: []interface{}{'e'}, keybinding: s.hideEqualizer},
		{views: []string{"equalizer"}, keys: []interface{}{ui.KeyTab}, keybinding: s.equalizer.next},
