...
func (s *screen) getKeys() []key {
	return []key{
		...
		{views: []string{""}, keys: []interface{}{'v'}, keybinding: s.volumeDown, help: keyHelp{key: "v", body: "volume down"}},
		{views: []string{""}, keys: []interface{}{'V'}, keybinding: s.volumeUp, help: keyHelp{key: "V", body: "volume up"}},
		...
		{views: []string{"body"}, keys: []interface{}{'r'}, keybinding: s.play.rewind, help: keyHelp{key: "r", body: "rewind the current song to the beginning"}},
